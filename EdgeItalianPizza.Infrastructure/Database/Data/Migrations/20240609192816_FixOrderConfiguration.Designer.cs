...
namespace EdgeItalianPizza.Infrastructure.Database.Data.Migrations
{
    ...
    [Migration("20240609192816_FixOrderConfiguration")]
    partial class FixOrderConfiguration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EdgeItalianPizza.Domain.Entities.Orders.PizzaToppings", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("topping_details_id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EdgeItalianPizza.Domain.Entities.Customers.Customer", b =>
                {
                    b.OwnsOne("EdgeItalianPizza.Domain.ValueObjects.Password", "Password", b1 =>
                        {
            ...
            modelBuilder.Entity("EdgeItalianPizza.Domain.Entities.Orders.PizzaToppings", b =>
                {
                    ...
                    b.HasOne("EdgeItalianPizza.Domain.Entities.Products.ToppingDetails", "Topping")
                        .WithMany("Pizzas")
            ...
            modelBuilder.Entity("EdgeItalianPizza.Domain.Entities.Orders.PromoCode", b =>
                {
                    ...
                    b.OwnsOne("EdgeItalianPizza.Domain.Entities.Orders.ValueObjects.Discount", "Discount", b1 =>
                        {
                            b1.Property<long>("PromoCodeId")
                                .HasColumnType("bigint");
